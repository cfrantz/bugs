...
#
#     bazel run @//third_party/rust:case3_deps
###############################################################################
"""
...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "greeting": "@case3_deps__greeting-0.1.0//:greeting",
            "serde": "@case3_deps__serde-1.0.152//:serde",
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        new_git_repository,
        name = "case3_deps__greeting-0.1.0",
        branch = "main",
        init_submodules = True,
        remote = "https://github.com/cfrantz/bugs",
        build_file = Label("@case3//third_party/rust/crates:BUILD.greeting-0.1.0.bazel"),
        strip_prefix = "minspec/greeting",
    )

    maybe(
        http_archive,
        name = "case3_deps__proc-macro2-1.0.51",
        ...
        build_file = Label("@case3//third_party/rust/crates:BUILD.proc-macro2-1.0.51.bazel"),
    )

    maybe(
        http_archive,
        name = "case3_deps__quote-1.0.23",
        ...
        build_file = Label("@case3//third_party/rust/crates:BUILD.quote-1.0.23.bazel"),
    )

    maybe(
        http_archive,
        name = "case3_deps__serde-1.0.152",
        ...
        build_file = Label("@case3//third_party/rust/crates:BUILD.serde-1.0.152.bazel"),
    )

    maybe(
        http_archive,
        name = "case3_deps__serde_derive-1.0.152",
        ...
        build_file = Label("@case3//third_party/rust/crates:BUILD.serde_derive-1.0.152.bazel"),
    )

    maybe(
        http_archive,
        name = "case3_deps__syn-1.0.107",
        ...
        build_file = Label("@case3//third_party/rust/crates:BUILD.syn-1.0.107.bazel"),
    )

    maybe(
        http_archive,
        name = "case3_deps__unicode-ident-1.0.6",
        ...
        build_file = Label("@case3//third_party/rust/crates:BUILD.unicode-ident-1.0.6.bazel"),
    )
